...
namespace topic___receive
{
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://prueba456.servicebus.windows.net/;SharedAccessKeyName=app;SharedAccessKey=U7P8fXhVuw/L2AuIIAjfqQWpkWBpXgbDAUD5cKipjZc=;EntityPath=topicdemo";

        private static ISubscriptionClient _client;
        private static string _subscription_name = "demo3";
